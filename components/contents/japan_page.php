<h1 class="page_title">Японский словарь</h1>

<form action="controllers/add.php" method="POST" class="add_block">
    <label for="word" class="add_block_label"><p>Слово:</p>
        <input id="word" type="text" name="japan_word" class="add_block_input">
    </label>
    <label for="tranlate" class="add_block_label"><p>Перевод:</p>
        <input id="tranlate" type="text" name="japan_tranlate" class="add_block_input" placeholder="перевод1, перевод2">
    </label>
    <input type="submit" name="add_japan_word" class="add_block_sub" value="Добавить">
...
<div class="words_block">
    ...
    <?php
        $str_out_words = "SELECT * FROM `japan_words`";
